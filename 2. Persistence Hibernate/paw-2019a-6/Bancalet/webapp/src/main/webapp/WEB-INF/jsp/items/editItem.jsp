						...
						<div class="col-sm-12">
							<div class="card-box mt-3">
								...
								<form:form modelAttribute="ItemRegisterForm"
									action="${postPath}" method="post" enctype = "multipart/form-data">
									<div class="card-body">
									...
									<!-- image item -->
										...
										<div class="col-lg-12 p-t-20">
											<div class="form-group">
											    ...
											    <div class="col-sm-10">
											    	<form:input type="text" id="datepicker" path="fecha_caducidad" cssClass="datepicker" value="${item.fechaCaducidad}"/>
