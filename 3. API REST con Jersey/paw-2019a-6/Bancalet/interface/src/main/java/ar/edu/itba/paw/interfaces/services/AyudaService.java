...
public interface AyudaService {
	...
	/**
	 * Encuentra todas las ayudas para una fechaResolucion dada.
	 *
	 * @param fechaResolucion La fecha en la que se cerró la ayuda.
	 * @return Todas las ayudas cuya fechaResolucion corresponda con la dada.
	 */
	Collection<Ayuda> findByFechaResol(Date fechaResolucion);
	 ...
	 *                        en Ayuda model.
	 * @param fechaResolucion Es la fecha en la que se resuelve la ayuda. Se inicia
	 *                        a null porque es el admin quien la cierra.
	 * @param informe         Si hay que anotar un informe sobre el problema se hace
	 *                        aquí para poder buscar en un futuro la solución si
	 *                        vuelve a ocurrir.
	...
	Validation createAyuda(String subject, String email, String name, String mensaje);
}
