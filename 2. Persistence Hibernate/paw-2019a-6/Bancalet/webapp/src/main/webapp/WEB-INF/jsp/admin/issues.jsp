							...
							<div class="card-box">
								...
								<div class="card-body">
									<div
										...
										<div class="search">
											 <form action="">
											 <input type="search" name="issue_nombre" value="${issue_nombre}" class="form-control" placeholder="
												<spring:message code="issue.search_name_form_label"/>">
											<p>
											<br>
												<b><spring:message code="issue.tipo_form_label" /></b>
												<select name="issue_tipo" >
													<option value="${issue_tipo}" selected><spring:message code="issue.select_${issue_tipo}"/></option>
													<c:if test="${issue_tipo != 0}">
														<option value="0"><spring:message code="issue.select_0"/></option>
													</c:if>
													<c:if test="${issue_tipo != 1}">
														<option value="1"><spring:message code="issue.select_1"/></option>
													</c:if>
													<c:if test="${issue_tipo != 2}">
												    	<option value="2"><spring:message code="issue.select_2"/></option>
											  		</c:if>
											  	</select>
											</p>
											...
											<br>
												<b><spring:message code="item.filtro" /></b>
													<c:if test="${issue_tipo == 1}">
														<spring:message code="issue.select_1" />
													</c:if>
													<c:if test="${issue_tipo == 2}">
														<spring:message code="issue.select_2" />
													</c:if>
													${issue_nombre}
											</p>
											</form>
															...
															<tr>
																...
																<td>
																	<div class="col-lg-12 text-center">
																		<a href="<c:url value="/admin/issues/${issue.idAyuda}"/>"
