					...
					<div class="row justify-content-center">
						<div class="col-sm-12">
							<div class="card-box card-box-user mx-auto mt-3">
								<div class="card-head">
									<header>
										<spring:message code="user.contact_header" arguments="${vendedor.username}" />
									</header>
								</div>
								<div class="card-body">
									<c:url value="/items/sendto/${itemId}" var="postPath" />
									<form:form modelAttribute="ContactForm" action="${postPath}"
										method="post">
										...
										<div class="col-lg-12 p-t-20">
											<div
												...
												<form:label type="text" path="mensaje"
													...
													<spring:message code="contact.mensaje_user" arguments="${vendedor.username}" />
												</form:label>
									...
									<a href="<c:url value="/items/${itemId}"/>"class="btn btn-default rebeccapurple-color ">
