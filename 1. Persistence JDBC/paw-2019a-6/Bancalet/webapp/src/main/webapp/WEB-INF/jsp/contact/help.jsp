					...
					<div class="row justify-content-center">
						<div class="col-sm-12">
							<div class="card-box card-box-user mx-auto mt-3">
								...
								<div class="card-body">
									<c:url value="/contactSucces" var="postPath" />
									<form:form modelAttribute="ContactAdminForm" action="${postPath}"
										...
										<div class="col-lg-12 p-t-20">
											<div
												...
												<form:label type="text" path="name"
													...
													<spring:message code="index.name_user" />
												</form:label>
												<form:input type="paragraph_text" path="name"
										...
										<div class="col-lg-12 p-t-20">
											<div
												class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<form:label type="text" path="email"
													cssClass="mdl-textfield__label">
													<spring:message code="index.email_user" />
												</form:label>
												<form:input type="paragraph_text" path="email"
													cssClass="mdl-textfield__input" />
